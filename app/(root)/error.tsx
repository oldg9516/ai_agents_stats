 ...
 *
 * Catches and handles errors in the support overview route segment
 * Follows Next.js error.tsx pattern
 */
export default function SupportOverviewError({
	error,
	reset,
}: {
		...
		<div className='flex min-h-screen items-center justify-center p-4'>
			<Card className='w-full max-w-md'>
				<CardHeader>
					...
					<CardDescription>
						An error occurred while loading support overview
					</CardDescription>
				</CardHeader>
				<CardContent className='space-y-4'>
					...
					<div className='space-y-2'>
						...
						<ul className='text-sm text-muted-foreground list-disc list-inside space-y-1'>
							...
							<li>Missing permissions for qualified agents</li>
						</ul>
					</div>
